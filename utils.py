...
def load_mnist_data(path = 'mnist.pkl.gz'):
	...
	with(gzip.open(path, 'rb')) as f:
		...
		train_set_x, train_set_y = to_numpy_format(train_set)
		test_set_x, test_set_y = to_numpy_format(test_set)
		valid_set_x, valid_set_y = to_numpy_format(valid_set)
...
'''
	Functions usefull for visualising the results
	those function come from deeplearning.net
